                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex ml-6 xl:ml-0">
                        <div className="flex items-center flex-shrink-0">
                            <h1 className="text-xl font-bold uppercase tracking-wider border border-spacing-4 px-6 py-3 rounded-md hover:bg-slate-500 transition-colors">Logo</h1>
                            {/* <img
                    ...
                    <div className="flex items-center justify-end ml-auto space-x-6">
                        ...
                        <Dropdown
                            ...
                            label={
                                <Avatar
                                    alt="User settings"
                                    img="https://utfs.io/f/8b034fb4-1f45-425a-8c57-a7a68835311f-2558r.png"
                        ...
                        >
                            <Dropdown.Header>
                                <span className="block text-sm">Name Doctor</span>
