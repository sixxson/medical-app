...
export default function ContactInfo({
    ...
    const { saveDbData, contactData, setContactData } = useOnBoardingContext()
    const { register, handleSubmit, reset, formState: { errors } } = useForm<ContactInfoFormProps>({
        defaultValues: {
            email: contactData.email || saveDbData.email,
            phone: contactData.phone || saveDbData.phone,
            country: contactData.country || saveDbData.country,
            city: contactData.city || saveDbData.city,
            state: contactData.state || saveDbData.state,
        }
    })
